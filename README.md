...
Current release: 1.4.1 with **FLAC** support (sorry but 64 bit binaries only as libflac-sys does not build on 32 bit)
...
- Sonos speaker using WAV format (thanks @Cunkers !). FLAC still untested
