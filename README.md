...
- some AVTtransport renderers will stop when detecting a pause between songs, you can use the "*Autoresume*" checkbox if you encounter this problem. However, with current versions of swyh-rs you should not have to use this checkbox. Try to disable "Chunked Transfer Encoding" frst instead. 
