...
widget-style-label = Widget-Stil: { $style }
language-label = Sprache: { $lang }
warn-language-changed = Sprache auf { $lang } geändert, Neustart erforderlich!!
warn-widget-style-changed = Widget-Stil auf { $style } geändert, Neustart erforderlich!!
...
chk-24bit = 24 Bit
sample-rate-label = Abtastrate (Hz):
sr-system-default = Systemstandard ({ $rate } Hz)
http-port-label = HTTP-Port:
chk-use-dither = 16-Bit TPDF-Dithering
