...
widget-style-label = Estilo de widget: { $style }
language-label = Idioma: { $lang }
warn-language-changed = Idioma cambiado a { $lang }, ¡¡se requiere reinicio!!
warn-widget-style-changed = Estilo de widget cambiado a { $style }, ¡¡se requiere reinicio!!
...
chk-enable-slimproto = Activar SlimProto
...
status-slimproto-disabled = Descubrimiento SlimProto desactivado
...
warn-slimproto-changed = Soporte SlimProto cambiado, ¡¡se requiere reinicio!!
